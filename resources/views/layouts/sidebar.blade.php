<div :class="sidebarOpen ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'" class="fixed z-30 inset-y-0 left-0 w-64 transition duration-300 transform bg-gray-900 overflow-y-auto lg:translate-x-0 lg:static lg:inset-0">
    <div class="flex items-center justify-center mt-8">
        <div class="flex items-center">
            ...
            {{-- <img src="images/JAYSIS GREEN ENERGY INFRA LOGO NEW.png" alt=""> --}}
            <img src="{{asset('images/Jaysis logo1.png')}}" alt="">
    ...
    <nav class="mt-10">
        ...
        <a class="flex items-center mt-4 py-2 px-6 text-gray-500 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100 {{ Route::currentRouteNamed('admin.roles.index') ? 'active' : '' }}"
            ...
            <img src="https://img.icons8.com/ios/50/000000/user-group-man-man.png"/ class="h-6 w-6">
            <span class="mx-3">Client's</span>
        </a>
        @endcanany
